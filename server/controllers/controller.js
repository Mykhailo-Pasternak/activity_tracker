// bookshelf-app/server/controllers/controller.js
// Import database
...
exports.booksCreate = async (req, res) => {
  ...
  knex("books")
    ...
    .then(() => {
      ...
      res.json({
        message: `Book \'${req.body.title}\' by ${req.body.author} created.`,
      });
    })
    .catch((err) => {
      // Send a error message in response
      res.json({
        message: `There was an error creating ${req.body.title} book: ${err}`,
      });
    });
};
...
exports.booksDelete = async (req, res) => {
  ...
  knex("books")
    ...
    .catch((err) => {
      // Send a error message in response
      res.json({
        message: `There was an error deleting ${req.body.id} book: ${err}`,
      });
    });
};
